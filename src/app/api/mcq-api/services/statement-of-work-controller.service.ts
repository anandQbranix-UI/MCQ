...
'document': Array<Blob>;
   ...
   */
  static readonly UpdateSowStatusPath = '/v1/statementOfWorkController/updateStatus';
   ...
   */
  static readonly DownloadAgreementSowPath = '/v1/statementOfWorkController/downloadAgreementForSow';
